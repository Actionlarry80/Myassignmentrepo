...
public final class ActivityAdminDashboardBinding implements ViewBinding {
  ...
  private ActivityAdminDashboardBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button btnAddProduct, @NonNull Button btnOrderList, @NonNull TextView textView) {
    this.rootView = rootView;
    this.btnAddProduct = btnAddProduct;
    this.btnOrderList = btnOrderList;
  ...
  public static ActivityAdminDashboardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btnOrderList;
      Button btnOrderList = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityAdminDashboardBinding((ConstraintLayout) rootView, btnAddProduct,
          btnOrderList, textView);
    }
