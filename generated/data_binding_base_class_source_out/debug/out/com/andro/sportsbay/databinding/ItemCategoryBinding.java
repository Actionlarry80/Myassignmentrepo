...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  private ItemCategoryBinding(@NonNull ConstraintLayout rootView, @NonNull TextView tvCategory) {
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCategoryBinding((ConstraintLayout) rootView, tvCategory);
    }
